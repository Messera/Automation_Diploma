...
public abstract class BasePage {
    ...
    protected void click(By locator) {
        log.debug("I click by ::" + locator);
        verifyElementClickable(locator);
        findElement(locator).click();
    }

    protected void click(WebElement webElement) {
        log.debug("I click by ::" + webElement);
        new UIElement(driver, wait, webElement).click();
    }


    protected String getText(By locator) {
        log.debug("I get text by ::" + locator);
        return findElement(locator).getText();
    }


    protected String getText(WebElement webElement) {
        log.debug("I get text by ::" + webElement);
        return webElement.getText();
    }

    protected List<String> getTexts(By locator) {
        log.debug("I get texts by ::" + locator);
